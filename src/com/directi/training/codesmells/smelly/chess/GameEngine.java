...
public class GameEngine
{
    ...
    private void resetWhite(int x, Color white)
    {
        for (int column = 0; column < 8; column++) {
            if (column == 0) {
                _chessBoard.getBoard()[x][column].setPiece(new LeftRook(white));
            } else if (column == 1) {
                _chessBoard.getBoard()[x][column].setPiece(new LeftKnight(white));
            } else if (column == 2) {
                _chessBoard.getBoard()[x][column].setPiece(new LeftBishop(white));
            } else if (column == 3) {
                _chessBoard.getBoard()[x][column].setPiece(new King(white));
            } else if (column == 4) {
                _chessBoard.getBoard()[x][column].setPiece(new Queen(white));
            } else if (column == 5) {
                _chessBoard.getBoard()[x][column].setPiece(new RightBishop(white));
            } else if (column == 6) {
                _chessBoard.getBoard()[x][column].setPiece(new RightKnight(white));
            } else if (column == 7) {
                _chessBoard.getBoard()[x][column].setPiece(new RightRook(white));
            }
        }
    }
